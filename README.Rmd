...
Large cell type-specific reference data that accompany the EG2 package have been uploaded to OSF (https://osf.io/czyvr/) and must be downloaded separately. In order to use the package, first download and unzip the data into a local directory...
```{bash OSF wget}
